...
public class ContainerJuliusP {
	...
	// Nachteil: ggf. hoher Speicherbedarf
	// Todo: Bewertung Speicherbedarf (F1)
	private static ContainerJuliusP instance = new ContainerJuliusP();
	 ...
	 * @return
	 */
	public static ContainerJuliusP getInstance() {
		return instance;
	}
	...
	public static void main (String[] args) throws Exception {
		...
		ContainerJuliusP con = ContainerJuliusP.getInstance();
		con.startEingabe(); 
	}
	...
	private void store() throws ContainerException {
		...
		try {
			fos = new FileOutputStream( ContainerJuliusP.LOCATION );
	...
	public void load() {
		...
		try {
		  fis = new FileInputStream( ContainerJuliusP.LOCATION );
